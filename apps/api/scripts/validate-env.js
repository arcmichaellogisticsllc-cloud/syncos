...
function requireHttpsUrl(errors, name, value, environmentName = "production") {
  if (!value) {
...
function requireSyncDomainEmail(errors, name, value) {
  if (!value) {
