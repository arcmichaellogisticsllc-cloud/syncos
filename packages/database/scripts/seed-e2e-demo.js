...
async function seedActionStateRecords(client) {
  ...
  await upsert(client, "production_records", { ...prodBase, id: actionIds.prodCorrectionRequested, production_notes: "E2E Action Production Correctable", status: "correction_required", submitted_by_user_id: admin, billable_status: "not_billable" });
  ...
  await upsert(client, "payment_batches", { ...pbBase, id: actionIds.paymentBatchUnderReview, payment_batch_number: "PB-ACT-002", batch_type: "mixed_later", status: "under_review", approval_status: "pending", execution_status: "not_submitted", notes: "E2E Action Payment Batch Approvable" });
  ...
  await upsert(client, "accounting_export_batches", { ...aexBase, id: actionIds.aexUnderReview, export_batch_number: "AEX-ACT-003", export_type: "mixed_later", status: "under_review", approval_status: "pending", export_status: "generated", generated_file_reference: "metadata-only:AEX-ACT-003", notes: "E2E Action Accounting Export Approvable" });
