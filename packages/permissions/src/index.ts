export type PermissionKey =
  ...
  | "account_onboarding.read"
  | "account_onboarding.create"
  | "account_onboarding.update"
  | "account_onboarding.archive"
  | "contact.read"
  | "contact.create"
  | "contact.update"
  | "contact.verify"
  ...
  | "partner_workforce.review"
  | "partner_workforce.evidence.review"
  ...
  | "syncfield_map.create"
  | "syncfield_map.version.upload"
  | "syncfield_map.read"
  | "syncfield_map.assignment.manage"
  | "syncfield_map.work_zone.manage"
  | "syncfield_jsa.read_all"
  | "partner_map.read"
  ...
  | "daily_production.read_all"
  | "daily_production.completeness_read"
  | "customer_qc.completeness_review"
  | "customer_qc.decision_record"
  | "customer_qc.evidence_read"
  | "customer_qc.evidence_upload"
  | "customer_qc.correction_publish"
  | "customer_qc.history_read"
  ...
  | "production_dashboard.read"
  | "production_export.generate"
  | "production_export.read"
  | "production_closeout.read"
  | "production_closeout.generate"
  ...
  | "contractor_payable.calculate_eligibility"
  | "financial_exception.read"
  | "partner_payment.execute"
  | "partner_payment.submit"
  | "partner_payment.confirm"
